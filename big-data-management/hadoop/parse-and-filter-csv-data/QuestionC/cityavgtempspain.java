...
public class cityavgtempspain {
    ...
    public static class Map
        ...
        public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
            ...
            if (line.length > 7 && "Spain".equals(line[1])) {
                city.set(line[3]); // Set city as the key
                try {
                    ...
                    if (tempValue != -99) { // Filter out unknown temperature values
                        ...
                        context.write(city, temperature);  // Emit <City, AvgTemperature>
                    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (otherArgs.length != 2) {
            System.err.println("Usage: cityavgtempspain <in> <out>");
            System.exit(2);
        }

        // create a job with name "cityaveragetempspain"
        Job job = new Job(conf, "cityaveragetempspain");
        job.setJarByClass(cityavgtempspain.class);
